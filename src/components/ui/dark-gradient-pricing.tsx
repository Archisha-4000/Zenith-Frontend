...
const Benefit = ({ text, checked }: BenefitProps) => {
  return (
    <div className="flex items-center gap-3">
      {checked ? (
        <span className="grid size-4 place-content-center rounded-full bg-black text-sm text-primary-foreground">
      ...
      >
        ...
        <div className="relative z-10 font-['Poppins']">
          <div className="flex flex-col items-center border-b pb-6 dark:border-zinc-700 border-zinc-200">
            ...
            <span className="text-white text-center">{bestFor}</span>
          </div>

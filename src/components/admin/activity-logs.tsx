...
export function ActivityLogs() {
  ...
  const activityLogs = [
    ...
    },
    {
      ...
      target: "Nasiruddin Thander - Promoted to Senior Manager",
    ...
    },
    {
      ...
      target: "Debarati Seal - Security Audit Task",
      type: "ai_assignment",
      status: "success",
      ipAddress: "system",
    ...
    },
    {
      ...
      target: "Archisha Upadhyaya - $4,500",
      type: "payment",
      status: "error",
      ipAddress: "192.168.1.100",

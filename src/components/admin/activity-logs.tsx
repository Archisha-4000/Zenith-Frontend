        ...
        <table className="min-w-full divide-y divide-zinc-700">
          <thead>
            <tr className="text-left text-zinc-400">
              ...
              <th className="py-3.5 pl-4 pr-3 text-sm font-semibold">Target</th>
              ...
              <th className="py-3.5 pl-4 pr-3 text-sm font-semibold">Details</th>
              <th className="py-3.5 pl-4 pr-3 text-sm font-semibold">Blockchain Hash</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-zinc-800">
            {filteredLogs.map((log) => (
              <tr key={log.id}>
                ...
                <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm text-zinc-300">{log.target}</td>
                ...
                <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm text-zinc-300">{log.details}</td>
                <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm text-zinc-300">
